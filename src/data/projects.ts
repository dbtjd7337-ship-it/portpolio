...
export const projects: Project[] = [
  // ─── Project A : 3D Modeling ──────────────────────────────────────────────
  {
    ...
    media: [
      { src: '/images/projectA/asurada/asurada_1.png', type: 'image' },
      { src: '/images/projectA/asurada/asurada_2.png', type: 'image' },
      { src: '/images/projectA/asurada/asurada_3.png', type: 'image' },
      { src: '/images/projectA/asurada/asurada_4.png', type: 'image' },
  ...
  },
  {
    ...
    thumbnail: { src: '/images/projectA/dog/dog_main.png', type: 'image' },
    media: [
      { src: '/images/projectA/dog/dog_1.png', type: 'image' },
  ...
  },
  {
    ...
    thumbnail: { src: '/images/projectA/mobi/mobi_main.png', type: 'image' },
    media: [
      { src: '/images/projectA/mobi/mobi_1.mp4', type: 'video' },
      { src: '/images/projectA/mobi/mobi_2.png', type: 'image' },
      { src: '/images/projectA/mobi/mobi_3.png', type: 'image' },
    ],
    behanceLinks: [
      {
        url: 'https://www.behance.net/gallery/193852131/MMZ-Project-MOBI',
        label: 'MMZ Project MOBI',
        thumbnail: '/images/projectA/mobi/mobi_thum1.png',
      },
      {
        url: 'https://www.behance.net/gallery/188374521/MMZ-BXWebUIUXContent',
        label: 'MMZ BX · Web UI/UX · Content',
        thumbnail: '/images/projectA/mobi/mobi_thum2.png',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    media: [
      { src: '/images/projectA/rolex/rolex_1.png', type: 'image' },
      { src: '/images/projectA/rolex/rolex_2.png', type: 'image' },
      { src: '/images/projectA/rolex/rolx_3.png', type: 'image' },
      { src: '/images/projectA/rolex/rolex_4.png', type: 'image' },
      { src: '/images/projectA/rolex/rolex_5.png', type: 'image' },
      { src: '/images/projectA/rolex/rolex_6.png', type: 'image' },
      { src: '/images/projectA/rolex/rolex_7.png', type: 'image' },
      { src: '/images/projectA/rolex/rolex_8.png', type: 'image' },
    ...
    behanceLinks: [
      {
        ...
        thumbnail: '/images/projectA/rolex/rolex_thum.png',
      },
    ],
  },
  {
    ...
    media: [
      { src: '/images/projectA/rx78/rx78_1.png', type: 'image' },   // 0
      { src: '/images/projectA/rx78/rx78_2.png', type: 'image' },   // 1
      { src: '/images/projectA/rx78/rx78_3.png', type: 'image' },   // 2
      { src: '/images/projectA/rx78/rx78_4.png', type: 'image' },   // 3
      { src: '/images/projectA/rx78/rx78_5.png', type: 'image' },   // 4
      { src: '/images/projectA/rx78/rx78_6.png', type: 'image' },   // 5
      { src: '/images/projectA/rx78/rx78_7.png', type: 'image' },   // 6
      { src: '/images/projectA/rx78/rx78_8.png', type: 'image' },   // 7
      { src: '/images/projectA/rx78/rx78_9.png', type: 'image' },   // 8
      { src: '/images/projectA/rx78/rx78_10.png', type: 'image' },  // 9
    ],
    mediaLayout: [
  ...
  },
  {
    ...
    media: [
      ...
      { src: '/images/projectA/tiger/tiger_2.png', type: 'image' },
      { src: '/images/projectA/tiger/tiger_3.png', type: 'image' },
      { src: '/images/projectA/tiger/tiger_4.png', type: 'image' },
      { src: '/images/projectA/tiger/tiger_5.mp4', type: 'video' },
      { src: '/images/projectA/tiger/tiger_6.png', type: 'image' },
    ],
    mediaLinks: {
    ...
    behanceLinks: [
      {
        ...
        thumbnail: '/images/projectA/tiger/tiger_thum.png',
  ...
  },
  {
    ...
    thumbnail: { src: '/images/projectA/Pulzz/pulzz_4.png', type: 'image' },
    media: [
      ...
      { src: '/images/projectA/Pulzz/pulzz_3.png', type: 'image' },    // 3
      { src: '/images/projectA/Pulzz/pulzz_4.png', type: 'image' },    // 4
      { src: '/images/projectA/Pulzz/pulzz_5.png', type: 'image' },    // 5
      { src: '/images/projectA/Pulzz/pulzz_6.png', type: 'image' },    // 6
      { src: '/images/projectA/Pulzz/pulzz_7.png', type: 'image' },    // 7
      { src: '/images/projectA/Pulzz/pulzz_8.png', type: 'image' },    // 8
      { src: '/images/projectA/Pulzz/pulzz_9.png', type: 'image' },    // 9
      { src: '/images/projectA/Pulzz/pulzz_10.png', type: 'image' },   // 10
      { src: '/images/projectA/Pulzz/pulzz_11.png', type: 'image' },   // 11
      { src: '/images/projectA/Pulzz/pulzz_12.png', type: 'image' },   // 12
      { src: '/images/projectA/Pulzz/pulzz_13.png', type: 'image' },   // 13
      { src: '/images/projectA/Pulzz/pulzz_14.png', type: 'image' },   // 14
      { src: '/images/projectA/Pulzz/pulzz_15.png', type: 'image' },   // 15
      { src: '/images/projectA/Pulzz/pulzz_16.png', type: 'image' },   // 16
      { src: '/images/projectA/Pulzz/pulzz_17.png', type: 'image' },   // 17
      { src: '/images/projectA/Pulzz/pulzz_18.png', type: 'image' },   // 18
    ],
    mediaLayout: [
      [0, 1, 2],      // main, 1, 2
      [3, 4],         // 3, 4
    ...
    behanceLinks: [
      {
        ...
        thumbnail: '/images/projectA/Pulzz/pulzz_thum.png',
      },
    ],
  },
  // ─── Project B : AI & Web ─────────────────────────────────────────────────
  {
    ...
    thumbnail: { src: '/images/projectB/ridy/ridy_main.png', type: 'image' },
    mediaLayout: [0, 1, 2, 3, 4, 5, 6, 7],
    media: [
      { src: '/images/projectB/ridy/ridy_1.png', type: 'image', caption: '렌탈·정산·배달, 라이더를 위한 통합 솔루션의\n첫 화면.' },
      { src: '/images/projectB/ridy/ridy_2.png', type: 'image', caption: '자주 쓰는 핵심 기능을 한 화면에서\n바로 접근할 수 있도록 설계한 서비스 허브다.' },
      { src: '/images/projectB/ridy/ridy_3.png', type: 'image', caption: '웹과 모바일 환경 모두에서\n최적화된 레이아웃을 제공.' },
      { src: '/images/projectB/ridy/ridy_4.png', type: 'image', caption: '렌탈 기종을 등록하고 관리하는\n운영자용 어드민 페이지.' },
      { src: '/images/projectB/ridy/ridy_5.png', type: 'image', caption: '전국 서비스센터 정보를 등록하고\n관리할 수 있는 어드민 페이지.' },
      { src: '/images/projectB/ridy/ridy_6.png', type: 'image', caption: '서비스 운영 데이터를 시각화해\n의사결정에 활용할 수 있도록 설계했다.' },
      { src: '/images/projectB/ridy/ridy_7.png', type: 'image' },
      { src: '/images/projectB/ridy/ridy_8.png', type: 'image', caption: '전체 기능 정의, 정책, 로직을 하나의 문서로 정리해\n개발 전 모든 기준을 세운 기획 문서.' },
    ],
  },
  {
    id: '2gatur',
  ...
  // ─── Project C : Visual ───────────────────────────────────────────────────
  {
    ...
    thumbnail: { src: '/images/projectC/hideout/hideout_main.png', type: 'image' },
    mediaLayout: [[0, 1], 2, 3, 4],
    media: [
      { src: '/images/projectC/hideout/hideout_1.png', type: 'image' },
      { src: '/images/projectC/hideout/hideout_2.png', type: 'image' },
      { src: '/images/projectC/hideout/hideout_3.png', type: 'image' },
      { src: '/images/projectC/hideout/hideout_4.png', type: 'image' },
      { src: '/images/projectC/hideout/hideout_5.png', type: 'image' },
    ],
  },
  {
    id: 'oille-room',
